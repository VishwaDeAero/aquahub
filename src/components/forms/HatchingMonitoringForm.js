    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 gap-6 mb-10">
                ...
                {/* Spawning Tank No */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 items-center">
                    <label className="text-gray-900">Spawning Tank No</label>
                    <input
                        type="number"
                        name="spawningTankNo"
                ...
                {/* Hatching Tank No */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 items-center">
                    <label className="text-gray-900">Hatching Tank No</label>
                    <input
                        type="number"
                        name="hatchingTankNo"
                ...
                {/* Egg Quality (%) */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 items-center">
                    <label className="text-gray-900">Egg Quality (%)</label>
                    <input
                        type="number"
                        name="eggQuality"
                ...
                {/* Number of Eggs */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 items-center">
                    <label className="text-gray-900">Number of Eggs</label>
                    <input
                        type="number"
                        name="numberOfEggs"
                ...
                {/* Number of Nauplii */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 items-center">
                    <label className="text-gray-900">Number of Naupilli</label>
                    <input
                        type="number"
                ...
                {/* Nauplii Stage */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 items-center">
                    <label className="text-gray-900">Naupilli Stage</label>
                    <input
                        type="text"
                        name="naupliiStage"
                ...
                {/* Hatching Rate */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 items-center">
                    <label className="text-gray-900">Hatching Rate</label>
                    <input
                        type="number"
                        name="hatchingRate"
